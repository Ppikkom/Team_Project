...
[NodeDescription(name: "NavigateToVector3List", story: "[Agent] to [WayPoints]", category: "Action", id: "2278f73b76fac6f2e4110bca0f10f738")]
internal partial class NavigateToVector3ListAction : Action
{
    ...
    {
        //m_CurrentPatrolPoint = 0; // 혹시 넣었음. 필요없을 가능성 농후
        //Debug.Log(m_CurrentPatrolPoint);
    ...
    protected override Status OnUpdate()
    {
        ...
        if (m_CurrentPatrolPoint == Waypoints.Value.Count)
        {
    ...
    {
        m_CurrentPatrolPoint = (m_CurrentPatrolPoint + 1);
